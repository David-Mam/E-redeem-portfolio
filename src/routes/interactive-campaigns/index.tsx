...
export const Route = createFileRoute("/interactive-campaigns/")({
  component: InteractiveCampaignsIndex,
});

function InteractiveCampaignsIndex() {
  return (
    <section className="bg-white overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
        ...
        >
          {campaigns.map((c) => (
            <ScrollStaggerItem key={c.slug} distance={18}>
        ...
        >
          ...
          <Link
            to="/contacts"
            className="inline-flex items-center gap-2 rounded-md px-6 py-3 text-sm font-bold shadow-lg transition-all hover:brightness-110"
